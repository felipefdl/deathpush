...
describe("getStatusColor", () => {
  it("returns modified color for modified", () => {
    expect(getStatusColor("modified")).toBe(
  ...
  it("returns untracked color for untracked", () => {
    expect(getStatusColor("untracked")).toBe(
