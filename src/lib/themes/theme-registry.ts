...
const THEMES: ThemeRegistration[] = [
  { entry: { id: "dark-modern", label: "Dark Modern", description: "Default Dark Modern", uiTheme: "vs-dark", kind: "dark" }, json: darkModernJson as VscodeThemeJson },
  { entry: { id: "dark-plus", label: "Dark+", description: "Default Dark+", uiTheme: "vs-dark", kind: "dark" }, json: darkPlusJson as VscodeThemeJson },
  { entry: { id: "dark-vs", label: "Dark (Visual Studio)", description: "Visual Studio Dark", uiTheme: "vs-dark", kind: "dark" }, json: darkVsJson as VscodeThemeJson },
  ...
  { entry: { id: "deathayu-dark", label: "DeathAyu Dark", uiTheme: "vs-dark", kind: "dark" }, json: deathayuDarkJson as VscodeThemeJson },
  ...
  { entry: { id: "light-modern", label: "Light Modern", description: "Default Light Modern", uiTheme: "vs", kind: "light" }, json: lightModernJson as VscodeThemeJson },
  { entry: { id: "light-plus", label: "Light+", description: "Default Light+", uiTheme: "vs", kind: "light" }, json: lightPlusJson as VscodeThemeJson },
  { entry: { id: "light-vs", label: "Light (Visual Studio)", description: "Visual Studio Light", uiTheme: "vs", kind: "light" }, json: lightVsJson as VscodeThemeJson },
  ...
  { entry: { id: "deathayu-light", label: "DeathAyu Light", uiTheme: "vs", kind: "light" }, json: deathayuLightJson as VscodeThemeJson },
