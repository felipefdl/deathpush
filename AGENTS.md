...
| Themes | Zed theme schema; bundled families under `assets/themes/` |
...
just icons               # re-vendor Lucide and Material icons, regenerate tables
just themes              # re-vendor pinned Zed theme revisions
